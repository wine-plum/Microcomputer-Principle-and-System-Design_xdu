DATA SEGMENT
    ChooseModel DB 'Plesse input the function number(1-5):','$'
    Model1txt1 DB 'Now, we are doing function 1:','$'
    Model1txt2 DB 'please input character:','$'
    Model2txt1 DB 'Now, we are doing function 2:','$'
    Model2txt2 DB 'please input character:','$'
    Model2txt3 DB 'The maximum is:','$'
    Model3txt1 DB 'Now, we are doing function 3:','$'
    Model3txt2 DB 'please input the decimal number:','$'
